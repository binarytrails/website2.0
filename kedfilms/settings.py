...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(DIR, 'kedfilms.sqlite3'),  # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(PROJECT_ROOT, 'frontend/static/frontend')
...
TEMPLATE_DIRS = (
    os.path.join(PROJECT_ROOT, 'projects/templates/'),
